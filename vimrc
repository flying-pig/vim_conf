...
" map: map, nmap, noremap, nnoremap
" map vs nmap: map means recursive version mapping, nmap means non-recursive
" mapping
" nmap vs  nnoremap, the n before map/noremap, means mode, n: normal mode,
" and it can be i/v (inser/visual) mode
...
" auto complete settings, !important, very usefull for me
